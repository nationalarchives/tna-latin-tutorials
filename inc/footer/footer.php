...
<div class="container">
    <div class="newsletter-template">
        <div class="news-icon">
            <img src="<?php echo SITE_URL ?>img/tna-newsletter-icon.png"
...
<!-- SCRIPTS -->
<script src="<?php echo SITE_URL ?>js/tna-base.min.js"></script>
